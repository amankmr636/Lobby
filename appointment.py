...
class Appointment:
    ...
    def __init__(self,root):
        ...
        TitleLabel=Label(self.root,bd=20,relief=RIDGE,text="Appointment System",fg="orange",bg="white",font=("times new roman",50,"bold"))
        ...
        slot1b = ttk.Combobox(DataFrameLeft,font=("times new roman", 12, "bold"),textvariable=self.var3)
        slot1b["values"]=row3b
        slot1b.grid(row=2, column=1)
        ...
        slot2b = ttk.Combobox(DataFrameLeft,font=("times new roman", 12, "bold"),textvariable=self.var4)
        slot2b["values"]=row3b
        slot2b.grid(row=3, column=1)
        ...
        slot3b = ttk.Combobox(DataFrameLeft,font=("times new roman", 12, "bold"),textvariable=self.var5)
        slot3b["values"]=row3b
        slot3b.grid(row=4, column=1)

        slot4 = Label(DataFrameLeft, text="12:00 AM - 12:30 AM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot4.grid(row=5, column=0)

        slot4b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var6)
        slot4b["values"] = row3b
        slot4b.grid(row=5, column=1)

        slot5 = Label(DataFrameLeft, text="12:30 AM - 01:00 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot5.grid(row=6, column=0)

        slot5b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var7)
        slot5b["values"] = row3b
        slot5b.grid(row=6, column=1)


        slot6 = Label(DataFrameLeft, text="02:00 PM - 02:30 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot6.grid(row=7, column=0)

        slot6b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var8)
        slot6b["values"] = row3b
        slot6b.grid(row=7, column=1)

        #============================Right Slot==============================================================
        slot7 = Label(DataFrameLeft, text="2:30 PM - 3:00 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot7.grid(row=3, column=2)

        slot7b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var9)
        slot7b["values"] = row3b
        slot7b.grid(row=3, column=3)

        slot8 = Label(DataFrameLeft, text="3:00 PM - 3:30 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot8.grid(row=4, column=2)

        slot8b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var10)
        slot8b["values"] = row3b
        slot8b.grid(row=4, column=3)

        slot8c = Label(DataFrameLeft, text="3:30 PM - 4:00 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot8c.grid(row=5, column=2)

        slot8bc = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var11)
        slot8bc["values"] = row3b
        slot8bc.grid(row=5, column=3)


        slot9 = Label(DataFrameLeft, text="4:00 PM - 4:30 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot9.grid(row=6, column=2)

        slot9b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var12)
        slot9b["values"] = row3b
        slot9b.grid(row=6, column=3)


        slot10 = Label(DataFrameLeft, text="4:30 PM - 5:00 PM", padx=2, pady=6, font=("times new roman", 12, "bold"))
        slot10.grid(row=7, column=2)

        slot10b = ttk.Combobox(DataFrameLeft, font=("times new roman", 12, "bold"), textvariable=self.var13)
        slot10b["values"] = row3b
        slot10b.grid(row=7, column=3)
        ...
        btnPrescriptionData=Button(ButtonFrame,text="Appoint Data",font=("times new roman", 12, "bold"),command=self.PrescriptionData,bg="blue",fg="white",width=16,height=1,padx=2,pady=6)
        ...
        btnPrint=Button(ButtonFrame,text="Print Prescription",font=("times new roman", 12, "bold"),command=self.printfun,bg="green",fg="white",width=16,height=1,padx=2,pady=6)
        btnPrint.grid(row=0,column=6)

        btnUpdate = Button(ButtonFrame, text="Update", font=("times new roman", 12, "bold"), bg="purple",
    ...
    def Exit(self):
        Ex=messagebox.askyesno("Appointment System","Confirm Exit")
        if Ex>0:
            self.root.destroy()
            return
